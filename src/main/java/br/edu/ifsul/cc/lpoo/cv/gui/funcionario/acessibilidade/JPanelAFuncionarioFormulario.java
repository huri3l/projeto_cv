                                    ...
                                    if(cbxCargo.getSelectedIndex() != 0) {
                                        ...
                                        if (txfCtps.getText().trim().length() == 14) {
                                            ...
                                            if (txfPis.getText().trim().length() > 1) {
                                                ...
                                                JOptionPane.showMessageDialog(this, "Número de PISé um campo obrigatório!inválido! Tente novamente no seguinte formato: 000.00000.00-0", "Fornecedor", JOptionPane.ERROR_MESSAGE);
                                            }

                                        } else {
                                            txfCtps.setBorder(new LineBorder(Color.red, 1));
                                            JOptionPane.showMessageDialog(this, "Número de CTPS inválido! Tente novamente no seguinte formato: 000.00000.00-0", "Fornecedor", JOptionPane.ERROR_MESSAGE);
                                        }
                                    } else {
                                        cbxCargo.setBorder(new LineBorder(Color.red, 1));
                                        JOptionPane.showMessageDialog(this, "É necessário selecionar algum Cargo!", "Fornecedor", JOptionPane.ERROR_MESSAGE);
                                    }
